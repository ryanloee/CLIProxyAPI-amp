...
func TestManagementUsageQueueRoute(t *testing.T) {
	...
	missingKeyReq.RemoteAddr = "127.0.0.1:12345"
	...
	legacyReq.RemoteAddr = "127.0.0.1:12345"
	...
	if len(payload) != 2 {
		t.Fatalf("response records = %d, want 2 body=%s", len(payload), authRR.Body.String())
	}
}
